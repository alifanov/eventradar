# coding: utf-8
# Django settings for eventradar project.
import os
import random
...
BASE_DIR = os.path.abspath(u'{}/../'.format(os.path.dirname(__file__)))
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'eventdb'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '7n$vfv&g0)gi+ekz4gg%6-yx&s##px%er92v$l8$1t!^y(l$&2'
...
ROOT_URLCONF = 'eventradar.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'eventradar.wsgi.application'
...
VK_API_SECRET = 'pPGdZM2rVbNySaTBfooe'
